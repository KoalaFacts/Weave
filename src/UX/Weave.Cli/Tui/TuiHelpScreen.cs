...
internal sealed class TuiHelpScreen
{
    public void Render()
    {
        CliTheme.WriteSection("Help");

        RenderGroup("Getting started", new (string Cmd, string Aliases, string Desc)[]
        {
        ...
        RenderGroup("Chat with an agent", new (string Cmd, string Aliases, string Desc)[]
        {
        ...
        RenderGroup("Workspace", new (string Cmd, string Aliases, string Desc)[]
        {
        ...
        RenderGroup("Monitor", new (string Cmd, string Aliases, string Desc)[]
        {
        ...
        RenderGroup("About this CLI", new (string Cmd, string Aliases, string Desc)[]
        {
            ("/version", "/v", "Installed version + cached update info"),
            ("/upgrade", "/update", "Check NuGet for a newer release"),
        });

        RenderGroup("Housekeeping", new (string Cmd, string Aliases, string Desc)[]
        {
