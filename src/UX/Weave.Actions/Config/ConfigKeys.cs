...
/// <summary>
/// Canonical names of the config keys recognized by the action layer. The
/// <c>All</c> set is the read surface for <see cref="GetConfigAction"/>'s
/// single-key path; the <c>Writable</c> subset is what
/// <c>SetConfigAction</c> accepts. Both lookups are case-insensitive; this
/// list is the canonical-case rendering frontends (e.g., shell completion
/// sources) can surface to users.
/// </summary>
