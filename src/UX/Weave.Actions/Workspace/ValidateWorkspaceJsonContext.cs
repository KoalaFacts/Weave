...
/// <summary>
/// Wire shape sent to <c>POST /api/workspaces/validate</c>: just the raw
/// JSON(C) text of the manifest. Internal because frontends pass a path
/// through <see cref="ValidateWorkspaceInput"/>; the action reads the file
/// before serializing this body.
/// </summary>
internal sealed record ValidateWorkspaceWire(string ManifestJson);
...
/// human-readable message when the silo returns 400 (parse failure).
/// </summary>
