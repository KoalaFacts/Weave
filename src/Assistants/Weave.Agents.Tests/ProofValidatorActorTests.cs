...
public sealed class ProofValidatorActorTests
{
    private static ProofValidatorActor CreateValidator(IChatClient? chatClient = null)
    {
    ...
    private static ProofValidatorActor CreateValidatorWithFactory(out IAgentChatClientFactory factory)
    {
    ...
    public void BuildUserMessage_IncludesProofItemsAndConditions()
    {
        ...
        var message = ProofValidatorActor.BuildUserMessage(proof, conditions);
    ...
    public void ParseConditionResults_ValidJson_ReturnsResults()
    {
        ...
        var results = ProofValidatorActor.ParseConditionResults(json);
    ...
    public void ParseConditionResults_JsonInMarkdown_ExtractsArray()
    {
        ...
        var results = ProofValidatorActor.ParseConditionResults(wrapped);
    ...
    public void ParseConditionResults_PlainJsonWithSurroundingText_ExtractsArray()
    {
        ...
        var results = ProofValidatorActor.ParseConditionResults(text);
    ...
    public void BuildUserMessage_SingleItemNoUri_OmitsUriLine()
    {
        ...
        var message = ProofValidatorActor.BuildUserMessage(proof, DefaultConditions());
    ...
    public void BuildUserMessage_EmptyConditions_StillIncludesProofItems()
    {
        ...
        var message = ProofValidatorActor.BuildUserMessage(proof, []);
