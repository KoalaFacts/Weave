...
public sealed class StorageConnectionStringsTests
{
    ...
    {
        var (host, port) = StorageConnectionStrings.ParseHostPort(connectionString, 6379);
    ...
    {
        var (host, port) = StorageConnectionStrings.ParseKeyValueHostPort(connectionString, "Host", 5432);
    ...
    {
        var (host, port) = StorageConnectionStrings.ParseSqlServerHostPort(connectionString);
    ...
    {
        var masked = StorageConnectionStrings.MaskSecret("Host=localhost;Password=secret;Database=weave");
    ...
    {
        var dataSource = StorageConnectionStrings.TryGetSqliteDataSource("Data Source=.weave/workspace.db;Mode=ReadWrite");
    ...
    {
        var replaced = StorageConnectionStrings.ReplaceSqliteDataSource("Data Source=old.db;Mode=ReadWrite", "new.db");
    ...
    {
        var replaced = StorageConnectionStrings.ReplaceDatabaseName("Server=.;Database=old;Initial Catalog=legacy;User Id=weave", "newdb");
