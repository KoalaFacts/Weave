...
The Deployment subsystem translates workspace manifests into platform-specific deployment configurations. It is a stateless translation layer with no CQRS, events, or actors.
